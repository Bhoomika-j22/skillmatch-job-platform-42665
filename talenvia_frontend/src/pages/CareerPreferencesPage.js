...
export default function CareerPreferencesPage() {
  ...
  const [role, setRole] = useState(
    () =>
      window.localStorage.getItem("talenvia.pref.role") || "Frontend Engineer",
  );
  ...
  const [level, setLevel] = useState(
    () => window.localStorage.getItem("talenvia.pref.level") || "Mid",
  );
  ...
  const save = () => {
    if (!role.trim()) {
      toast({
        title: "Fix required",
        message: "Target role cannot be empty.",
        variant: "error",
      });
      return;
    }
    ...
    toast({
      title: "Saved",
      message: "Career preferences updated.",
      variant: "success",
    });
  };
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
          ...
          <div>
            ...
            <p className="page-subtitle">
              Manage job recommendation preferences.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-2" style={{ maxWidth: 980 }}>
        <Card title="Preferences">
          ...
          <p className="mini" style={{ margin: 0, lineHeight: 1.45 }}>
            These preferences will be used to improve job matches once backend
          ...
          <div className="list" style={{ gap: 10 }}>
            <div className="list-item" style={{ alignItems: "center" }}>
              <div>
                ...
                <p style={{ margin: "4px 0 0" }}>
                  Prioritize roles and locations aligned to your preference.
                </p>
              </div>
            </div>
            <div className="list-item" style={{ alignItems: "center" }}>
              <div>
                ...
                <p style={{ margin: "4px 0 0" }}>
                  Suggest skills commonly required for your selected role &
                  level.
                </p>
              </div>
            </div>
            <div className="list-item" style={{ alignItems: "center" }}>
              <div>
                ...
                <p style={{ margin: "4px 0 0" }}>
                  Focus content on your role path.
                </p>
              </div>
            </div>
          </div>
