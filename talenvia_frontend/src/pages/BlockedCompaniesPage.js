  ...
  const addCompany = () => {
    ...
    if (exists) {
      toast({
        ...
        message: "This company is already in your blocked list.",
        variant: "info",
      });
      return;
    }
    ...
    toast({
      title: "Added",
      message: "Company added to blocked list.",
      variant: "success",
    });
  };
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
          ...
          <div>
            ...
            <p className="page-subtitle">
              Choose companies you don’t want to show your profile to.
            </p>
          </div>
        </div>
      </div>
        ...
        <Card title={`Blocked list (${sortedBlocked.length})`}>
          {sortedBlocked.length === 0 ? (
            <div
              ...
              style={{ background: "rgba(245, 247, 251, 0.55)" }}
            >
              <div className="dash-empty-title">No blocked companies</div>
              <div className="dash-empty-text">
                Add a company above to prevent it from seeing your profile (demo
                UI).
              </div>
            </div>
          ) : (
            <div
              className="list"
              aria-label="Blocked companies list"
              style={{ gap: 10 }}
            >
                  ...
                  <div className="settings-unified-left" style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <p style={{ margin: "4px 0 0" }}>
                        Your profile won’t be shown to this company.
                      </p>
                    </div>
                  </div>
