...
export default function SettingsDetailPage() {
  ...
  const [mobile, setMobile] = useState(
    () => window.localStorage.getItem("talenvia.account.mobile") || "",
  );
  const [email, setEmail] = useState(
    () => window.localStorage.getItem("talenvia.account.email") || "",
  );
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
          ...
          <div>
            ...
            <p className="page-subtitle">
              Edit preferences and update account details.
            </p>
          </div>
        </div>
                ...
                <div className="settings-unified-titlewrap" style={{ flex: 1 }}>
                  ...
                  >
                    <Button
                      ...
                      type="button"
                      onClick={saveMobile}
                      disabled={!mobile.trim() || !mobileValid}
                    >
                      Save changes
                    </Button>
                  </div>
